...
describe WidgetsController do
  ...
  context "with render_views(false) nested in group with render_views" do
  render_views false
  ...
  describe "#create" do
    ...
    let(:widget) { mock_model Widget, :id => assigns(:widget).id }

    it "redirects to widget_url(@widget)" do
      subject.should redirect_to(widget_url(widget.id))
    end

    it "redirects do :action => 'show'" do
